...
public enum CBDataAggregationCommandType {
	CBDataAggregationProject("$project"),
	CBDataAggregationUnwind("$unwind"),
	CBDataAggregationGroup("$group"),
	CBDataAggregationMatch("$match")
    ;	
	
	private CBDataAggregationCommandType(final String text) {
        this.text = text;
    }
